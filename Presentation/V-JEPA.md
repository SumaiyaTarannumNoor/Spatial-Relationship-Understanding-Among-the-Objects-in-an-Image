...
Adrien et el. use a Vision Transformer (ViT) to process a video.

### Dataset
Adrien et el. combined several public datasets to construct an unsupervised video pretraining dataset, which they refer to as **VideoMix2M**. Specifically, they combined the videos from HowTo100M (HT), Kinetics-400/600/700 (K710) and Something-Something-v2 (SSv2), resulting in approximately 2 million videos.
